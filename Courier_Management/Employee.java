...
public class Employee extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Employee frame = new Employee("Kavya Keerthana");
	...
	public Employee(String ename) {
		...
		btn_empMenu.setBounds(10, 47, 148, 43);
		...
		btn_pickOrders.setBounds(10, 101, 148, 43);
		...
		btn_deliverOrders.setBounds(10, 153, 148, 43);
		...
		btn_deliveryDetails.setBounds(10, 207, 148, 43);
		...
		btn_viewEmpProfile.setBounds(10, 267, 148, 43);
...
//		            
		...
		try {
			...
			update_eid.setBackground(Color.WHITE);
			...
			update_ename.setBackground(Color.WHITE);
			...
			update_ebranch.setBackground(Color.WHITE);
