...
public class Admin extends JFrame {
	...
	public Admin() {
		...
		admin_tabbedPane.setBounds(171, 39, 665, 474);
		...
		lblViewOrders.setBounds(259, 11, 145, 42);
		viewOrders.add(lblViewOrders);
		
		JScrollPane scrollPane_2 = new JScrollPane();
		scrollPane_2.setBounds(10, 64, 640, 296);
		...
		scrollPane.setBounds(72, 66, 478, 188);
		...
		scrollPane_1.setBounds(49, 66, 552, 197);
		...
		btn_AdminMenu.setBounds(10, 47, 148, 43);
		...
		btn_AddEmployee.setBounds(10, 101, 148, 43);
		...
		btn_ViewOrder.setBounds(10, 153, 148, 43);
		...
		btn_ViewUser.setBounds(10, 207, 148, 43);
		...
		btn_ViewEmployee.setBounds(10, 267, 148, 43);
