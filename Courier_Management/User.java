...
/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					User frame = new User("Kavya Keerthana");
					//frame.setTitle();
	...
	public User(String uname) {
		...
		btn_newOrder.setBounds(10, 96, 169, 43);
		...
		btn_trackOrder.setBounds(10, 148, 169, 43);
		...
		btn_viewProfile.setBounds(10, 202, 169, 43);
		...
		btn_newOrder_1.setBounds(10, 42, 169, 43);
...
//				}
		...
		track_txt_panel.setBounds(10, 99, 620, 339);
		...
		track_txt.setHorizontalAlignment(SwingConstants.LEFT);
		track_txt.setFont(new Font("Times New Roman", Font.BOLD, 12));
		track_txt.setBounds(151, 11, 212, 238);
		...
		track_progress.setBounds(10, 279, 600, 18);
		...
		chck_placed.setFont(new Font("Times New Roman", Font.ITALIC, 15));
		chck_placed.setBounds(20, 44, 126, 23);
		...
		chckPicked.setFont(new Font("Times New Roman", Font.ITALIC, 15));
		chckPicked.setBounds(20, 96, 99, 23);
		...
		chckTransit.setFont(new Font("Times New Roman", Font.ITALIC, 15));
		chckTransit.setBounds(20, 149, 99, 23);
		...
		chckDelivered.setFont(new Font("Times New Roman", Font.ITALIC, 15));
		chckDelivered.setBounds(20, 200, 99, 23);
		track_txt_panel.add(chckDelivered);
		
		JSeparator separator_2 = new JSeparator();
		separator_2.setOrientation(SwingConstants.VERTICAL);
		separator_2.setBounds(24, 30, 4, 200);
		track_txt_panel.add(separator_2);
		
		JLabel track_txt_details = new JLabel("");
		track_txt_details.setHorizontalAlignment(SwingConstants.LEFT);
		track_txt_details.setFont(new Font("Times New Roman", Font.BOLD, 12));
		track_txt_details.setBounds(398, 11, 212, 238);
		...
		update_ufname.setBackground(Color.WHITE);
		...
		update_uid.setBackground(Color.WHITE);
		...
		update_uname.setBackground(Color.WHITE);
			         ...
			         case JOptionPane.YES_OPTION:{
			        	 try {
								...
								String query= "update user_details set fname='"+update_ufname.getText()+"', lname='"+update_ulname.getText()+
										"' , mobile= '"+update_umobile.getText()+"' ,mailid = '"+update_umail.getText()+"';";
